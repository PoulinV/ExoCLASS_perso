...
parser.add_argument("--helium_TLA", help="If True, the TLA is solved with helium. Default is True.", type=str2bool, default=True) #action='store_true')
...
parser.add_argument("--heat_switch", help="If True, includes photoheating during reionization.", type=str2bool, default=True) #ction='store_true')
